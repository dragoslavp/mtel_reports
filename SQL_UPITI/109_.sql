/* Formatted on 6/9/2016 10:12:26 AM (QP5 v5.252.13127.32847) */
SELECT BROJ_RADNIKA,
       PREZIME_IME,
       GRUPA_ZA_PLAN1,
       MJESTO_TROSKA,
       ...
       MJESTO_TROSKA_SI,
       CASE
       WHEN MJESTO_TROSKA_SI IN (SELECT MESTO_TROSKA FROM XXMT_HR_GRPL_MT WHERE GRUPA_ZA_PLAN=GRUPA_ZA_PLAN1) THEN 1
       ELSE 0
       END TEST,
       DATUM_OD,
       DATUM_DO      
  FROM (SELECT PAPF.EMPLOYEE_NUMBER BROJ_RADNIKA,
